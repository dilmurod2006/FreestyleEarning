...
def new_product(request):
    if request.method == "GET":
        form = NewProductForm()
        return render(request, 'Works/work_new.html', {'form':form})
...
def product_detail(request, product_id):
    ...
    return render(request, 'Works/work_detail.html', {'product':product})
...
def product_update(request, product_id):
    ...
    if request.user==product.author:
        if request.method=='GET':
            ...
            return render(request, 'Works/work_update.html', {'form':form, 'pr':product})
        elif request.method == 'POST':
...
def product_delete(request, product_id):
    ...
    if request.user==product.author:  
        ...
        return render(request, "Works/work_delete.html", {'product':product})
    else:
        messages.error(request, 'Access danied!')
        return redirect('Home:index')
